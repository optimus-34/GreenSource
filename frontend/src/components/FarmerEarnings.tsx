...
export default function FarmerEarnings() {
  ...
  const EarningsCard = ({ title, amount, icon }: { title: string, amount: number, icon: React.ReactNode }) => (
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Track your earnings across different time periods</p>
      </div>
